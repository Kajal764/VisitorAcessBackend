...
public class RegisterUserDto {
    ...
    @Column(nullable = false)
    @Pattern(regexp = "^([6789][0-9]{9})$|([+][9][1][-][6789][0-9]{9})$", message = "Mobile no invalid")
